...
exports["mffs"]["friend"] = function anonymous(locals) {
    ...
    buf.push("<td" + jade.attrs({
        ...
        src: true
    }) + '/><span class="mffs_user">' + jade.escape(null == (jade.interp = username) ? "" : jade.interp) + '</span><span class="mffs_level">' + jade.escape(null == (jade.interp = level) ? "" : jade.interp) + '</span><div class="mffs_detail"><button' + jade.attrs({
        "data-userid": username,
        "class": [ "pill-btn", "red-btn", "unfollow" ]
    }, {
        "data-userid": true
    }) + ">Unfollow</button><ul><li><a" + jade.attrs({
        href: "/profile/" + username + "/"
    }, {
        href: true
    }) + "><strong>" + jade.escape(null == (jade.interp = username) ? "" : jade.interp) + "</strong><em> \n(" + jade.escape((jade.interp = level) == null ? "" : jade.interp) + ')</em></a></li><li class="info">' + (null == (jade.interp = info) ? "" : jade.interp) + '</li></ul><textarea maxlength="500" cols="27" rows="5"></textarea><button class="pill-btn munsell-blue-btn post-btn">Post</button></div></div><p class="proppables">' + (null == (jade.interp = throbber) ? "" : jade.interp) + "</p></td>");
    return buf.join("");
};
...
exports["mffs"]["proppable"] = function anonymous(locals) {
    ...
    buf.push('</ul><textarea maxlength="500" cols="27" rows="5"></textarea><button class="pill-btn munsell-blue-btn post-btn">Comment</button></span></span>');
    return buf.join("");
};
