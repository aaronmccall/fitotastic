...
exports["mffs"]["friend"] = function anonymous(locals) {
    var buf = [];
    var locals_ = locals || {}, id = locals_.id, followed = locals_.followed, pic_url = locals_.pic_url, username = locals_.username, level = locals_.level, info = locals_.info;
